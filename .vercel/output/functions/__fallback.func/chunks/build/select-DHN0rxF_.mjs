...
import { a as ReactDOM, z as reactDomExports, _ as __assign, c as __rest, d as __spreadArray } from "./router-CTdYHFOk.mjs";
import { g as useDirection, f as useControllableState, h as useId, i as useLayoutEffect2, P as Primitive, a as createCollection, c as composeEventHandlers, d as createContextScope, u as useCallbackRef$1, e as dispatchDiscreteCustomEvent } from "./index-BcqomYnJ.mjs";
import { c as cn, u as useComposedRefs, a as composeRefs } from "./utils-CZ556u-x.mjs";
...
const SelectTrigger = reactExports.forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
  Trigger,
  {
    ref,
    className: cn(
      "flex h-10 w-full items-center justify-between gap-2 whitespace-nowrap rounded-xl border border-border/60 bg-secondary/40 px-3 py-2 text-sm shadow-sm backdrop-blur-sm ring-offset-background cursor-pointer transition-colors hover:bg-secondary/60 data-[placeholder]:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/40 focus:border-primary/50 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1",
      className
    ),
    ...props,
    children: [
...
const SelectItem = reactExports.forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
  Item,
  {
    ref,
    className: cn(
      "relative flex w-full cursor-pointer select-none items-center rounded-xl mx-1 my-0.5 py-2.5 pl-3 pr-9 text-sm outline-none transition-colors focus:bg-primary/15 focus:text-foreground data-[highlighted]:bg-primary/15 data-[state=checked]:bg-primary/20 data-[state=checked]:font-medium data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
      className
    ),
    ...props,
    children: [
