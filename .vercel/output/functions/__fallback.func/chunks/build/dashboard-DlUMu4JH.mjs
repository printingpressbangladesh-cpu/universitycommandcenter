import { U as reactExports, L as jsxRuntimeExports, R as React, y as getDefaultExportFromCjs, f as commonjsGlobal } from "./server-BB9Vuddr.mjs";
import { J as useAuth, M as useCourses, I as useAssignments, U as useStudy, L as Link } from "./router-CTdYHFOk.mjs";
...
function getTicks(props, fontSize, letterSpacing) {
  var tick = props.tick, ticks2 = props.ticks;
  props.viewBox;
  props.minTickGap;
  props.orientation;
...
function Dashboard() {
  ...
  const coursesWithAttendance = courses.filter((c2) => c2.totalClasses > 0);
  const overallAttendance = coursesWithAttendance.length > 0 ? Math.round(coursesWithAttendance.reduce((s2, c2) => s2 + c2.attendance, 0) / coursesWithAttendance.length) : null;
  const pending = assignments.filter((a2) => a2.status !== "done").length;
  const totalCredits = courses.reduce((s2, c2) => s2 + c2.credits, 0);
  const studyHours = totalMinutesThisWeek;
  const streak = 0;
  const weekly = EMPTY_WEEKLY;
  const [quote, setQuote] = reactExports.useState(motivationalQuotes[0]);
  reactExports.useEffect(() => {
    setQuote(motivationalQuotes[Math.floor(Math.random() * motivationalQuotes.length)]);
  }, []);
  const today = assignments.filter((a2) => a2.status !== "done").sort((a2, b) => +new Date(a2.due) - +new Date(b.due)).slice(0, 4);
  const semesterLabel = (/* @__PURE__ */ new Date()).getMonth() < 6 ? "Spring" : "Fall";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 animate-fade-in-up", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "glass-strong relative overflow-hidden rounded-3xl p-6 md:p-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -right-20 -top-20 h-64 w-64 rounded-full bg-gradient-primary opacity-30 blur-3xl" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -bottom-24 -left-10 h-56 w-56 rounded-full bg-[color:var(--cyan)] opacity-20 blur-3xl" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex flex-col gap-6 md:flex-row md:items-end md:justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "mt-1 text-3xl font-semibold tracking-tight md:text-4xl", children: [
            greeting(),
            ", ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: name })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 max-w-xl text-sm text-muted-foreground", children: isEmpty ? "Add your first course to start tracking your semester." : `${semesterLabel} ${(/* @__PURE__ */ new Date()).getFullYear()} · ${courses.length} course${courses.length !== 1 ? "s" : ""} · ${totalCredits} credits` })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass rounded-2xl px-4 py-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] uppercase tracking-wider text-muted-foreground", children: "Attendance" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-semibold", children: attendanceLabel })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass rounded-2xl px-4 py-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] uppercase tracking-wider text-muted-foreground", children: "Streak" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 text-2xl font-semibold", children: [
              streak,
              " ",
              streak > 0
            ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "grid grid-cols-2 gap-4 md:grid-cols-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "Attendance", value: attendanceLabel, sub: courses.length ? "Across all courses" : "Log classes to track", icon: CalendarCheck2, accent: "var(--cyan)" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "Pending tasks", value: String(pending), sub: courses.length ? `Across ${courses.length} courses` : "No assignments yet", icon: ClipboardList, accent: "var(--blue)" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "Courses", value: String(courses.length), sub: "This semester", icon: BookOpen, accent: "var(--purple)" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "Study this week", value: `${studyHours}h`, sub: "Use study planner to log time", icon: Timer, accent: "var(--success)" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "grid gap-6 lg:grid-cols-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-strong rounded-3xl p-6 lg:col-span-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4 flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-semibold", children: "Weekly focus" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Study hours & focus score" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/study", className: "inline-flex items-center gap-1 rounded-full bg-secondary/60 px-3 py-1 text-xs hover:bg-secondary", children: [
          "Open planner ",
          /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowUpRight, { className: "h-3 w-3" })
        ] })
      ] }),
      studyHours < 1 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-64 flex-col items-center justify-center rounded-2xl border border-dashed border-border/60 bg-secondary/20 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "No study sessions logged this week yet." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/study", className: "mt-3 text-sm font-medium text-primary hover:underline", children: "Start a focus session" })
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-64", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AreaChart, { data: weekly, margin: {
        left: -20,
        right: 8,
        top: 8,
        bottom: 0
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("defs", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "g1", x1: "0", y1: "0", x2: "0", y2: "1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "0%", stopColor: "oklch(0.7 0.18 265)", stopOpacity: 0.6 }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "100%", stopColor: "oklch(0.7 0.18 265)", stopOpacity: 0 })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "g2", x1: "0", y1: "0", x2: "0", y2: "1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "0%", stopColor: "oklch(0.78 0.14 210)", stopOpacity: 0.5 }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "100%", stopColor: "oklch(0.78 0.14 210)", stopOpacity: 0 })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CartesianGrid, { stroke: "oklch(1 0 0 / 0.06)", vertical: false }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(XAxis, { dataKey: "d", stroke: "currentColor", tickLine: false, axisLine: false, fontSize: 12 }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(YAxis, { stroke: "currentColor", tickLine: false, axisLine: false, fontSize: 12 }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Area, { type: "monotone", dataKey: "hrs", stroke: "oklch(0.7 0.18 265)", strokeWidth: 2, fill: "url(#g1)", name: "Hours" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Area, { type: "monotone", dataKey: "focus", stroke: "oklch(0.78 0.14 210)", strokeWidth: 2, fill: "url(#g2)", name: "Focus" })
      ] }) }) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "grid gap-6 lg:grid-cols-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-strong rounded-3xl p-6 lg:col-span-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4 flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-semibold", children: "Today & next up" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Sorted by deadline" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/assignments", className: "inline-flex items-center gap-1 rounded-full bg-secondary/60 px-3 py-1 text-xs hover:bg-secondary", children: [
            "View all ",
            /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowUpRight, { className: "h-3 w-3" })
          ] })
        ] }),
        today.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-2xl border border-dashed border-border/60 bg-secondary/20 p-8 text-center text-sm text-muted-foreground", children: "No pending assignments. Add tasks from the Assignments page." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: today.map((t) => {
          const due = new Date(t.due);
          const days = Math.ceil((+due - Date.now()) / 864e5);
          return /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "group flex items-center gap-3 rounded-2xl border border-border/60 bg-secondary/30 p-3 transition hover-lift", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `h-9 w-1.5 rounded-full ${t.priority === "high" ? "bg-destructive" : t.priority === "medium" ? "bg-[color:var(--warning)]" : "bg-[color:var(--success)]"}` }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate text-sm font-medium", children: t.title }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rounded-full bg-secondary px-2 py-0.5 text-[10px] uppercase tracking-wider text-muted-foreground", children: t.course })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1 h-1.5 w-full overflow-hidden rounded-full bg-muted", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full bg-gradient-primary", style: {
                width: `${t.progress}%`
              } }) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "shrink-0 text-right text-xs", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-medium", children: days <= 0 ? "Due today" : `In ${days}d` }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-muted-foreground", children: due.toLocaleDateString(void 0, {
                month: "short",
                day: "numeric"
              }) })
            ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-strong relative overflow-hidden rounded-3xl p-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Quote, { className: "absolute -right-2 -top-2 h-24 w-24 text-primary/10" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm uppercase tracking-wider text-muted-foreground", children: "Daily dose" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-3 text-lg leading-snug font-medium", children: [
          '"',
          quote,
          '"'
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setQuote(motivationalQuotes[Math.floor(Math.random() * motivationalQuotes.length)]), className: "mt-6 inline-flex rounded-xl bg-gradient-primary px-4 py-2 text-xs font-medium text-primary-foreground shadow-glow", children: "Inspire me again" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "glass-strong rounded-3xl p-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4 flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-semibold", children: "Your courses" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/courses", className: "inline-flex items-center gap-1 rounded-full bg-secondary/60 px-3 py-1 text-xs hover:bg-secondary", children: [
          courses.length ? "All courses" : "Add course",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowUpRight, { className: "h-3 w-3" })
        ] })
      ] }),
      courses.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center rounded-2xl border border-dashed border-border/60 bg-secondary/20 py-12 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "You haven't added any courses yet." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/courses", className: "mt-4 inline-flex items-center gap-2 rounded-xl bg-gradient-primary px-4 py-2 text-sm font-medium text-primary-foreground shadow-glow", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "h-4 w-4" }),
          " Add your first course"
        ] })
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-3 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5", children: courses.map((c2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/courses/$courseId", params: {
        courseId: c2.id
      }, className: "group rounded-2xl border border-border/60 bg-secondary/30 p-4 transition hover-lift", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rounded-md px-2 py-0.5 text-[10px] font-medium uppercase tracking-wider", style: {
            background: `color-mix(in oklab, ${c2.color} 20%, transparent)`,
            color: c2.color
          }, children: c2.code }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-2 line-clamp-2 text-sm font-medium", children: c2.name }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 h-1.5 w-full overflow-hidden rounded-full bg-muted", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full", style: {
          width: `${c2.progress}%`,
          background: `linear-gradient(90deg, ${c2.color}, var(--accent))`
        } }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 flex justify-between text-xs text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: c2.totalClasses > 0 ? `${c2.attendance}% attendance` : "No classes logged" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: c2.marks > 0 ? `${c2.marks}% marks` : "—" })
        ] })
      ] }, c2.id)) })
    ] })
  ] });
...
function StatCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-strong rounded-2xl p-5 hover-lift", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs uppercase tracking-wider text-muted-foreground", children: label }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid h-8 w-8 place-items-center rounded-lg", style: {
